...
function updateCoordinates(event) {
  ...
  coordinates.textContent = coords;

  // Send a message to the background script with the updated coordinates
  chrome.runtime.sendMessage({ action: 'updateCoordinates', coordinates: coords });
}
